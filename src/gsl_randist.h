...
double gsl_ran_beta (gsl_rng * r, const double a, const double b);
...
double gsl_ran_exponential (gsl_rng * r, const double mu);
...
double gsl_ran_gamma (gsl_rng * r, const double a, const double b);
